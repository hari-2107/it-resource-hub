...
* limitations under the License.
*/
var re = { mapValue: { fields: { __type__: { stringValue: "__max__" } } } };
var ie = { nullValue: "NULL_VALUE" };
...
function __PRIVATE_fromWatchChange(e, t) {
	...
	if ("targetChange" in t) {
		...
		const r = function __PRIVATE_fromWatchTargetChangeState(e) {
			...
			return e.useProto3Json ? (__PRIVATE_hardAssert(void 0 === t || "string" == typeof t), ByteString.fromBase64String(t || "")) : (__PRIVATE_hardAssert(void 0 === t || t instanceof Buffer || t instanceof Uint8Array), ByteString.fromUint8Array(t || /* @__PURE__ */ new Uint8Array()));
...
*/ var __PRIVATE_OrderedCodeWriter = class {
	constructor() {
		this.buffer = /* @__PURE__ */ new Uint8Array(1024), this.position = 0;
	}
	Ct(e) {
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/ var Ae = /* @__PURE__ */ new Uint8Array(0);
/**
...
*/ var __PRIVATE_BundleReaderImpl = class {
	constructor(e, t) {
		this.Xa = e, this.serializer = t, this.metadata = new __PRIVATE_Deferred(), this.buffer = /* @__PURE__ */ new Uint8Array(), this.eu = function __PRIVATE_newTextDecoder() {
